...
const zh = {
  ...
  "math.edit": "编辑公式",
  "subPage.placeholder": "选择一个子页面",
  "subPage.noView": "还没有可选择的页面",
  "emoji.pick": "选择表情",
  ...
  "settings.dataDirHint": "所有空间、文档、数据库和附件都保存在这里，可整体复制迁移",
...
const en: Record<MessageKey, string> = {
  ...
  "settings.dataDirHint": "All workspaces, docs, database and attachments are stored here. Copy the entire folder to migrate.",
